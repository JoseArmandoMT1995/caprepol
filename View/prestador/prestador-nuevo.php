...
<form id="frm-prestador" action="?c=prestador&a=Guardar" method="post" enctype="multipart/form-data">

  <div class="form-group">
        <label>idPrestador</label>
        <input type="text" name="idPrestador" value="<?php echo $prest->idPrestador; ?>" class="form-control" placeholder="Ingrese  idPrestador" data-validacion-tipo="requerido|min:20" />
    </div>
