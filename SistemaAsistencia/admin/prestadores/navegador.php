            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        if ($tipo_usuario=="AA"){
                            echo '<li><a href=""><i class="fa fa-database" style="font-size:15px"> </i>  Crear reporte de base de datos Prestador</a></li>';
                        }
                        if ($tipo_usuario=="AA"){
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            ...
                            if ($tipo_usuario=="AA"){
                                echo '<li><a href=""><i class="fa fa-database" style="font-size:15px"> </i>  Crear reporte de base de datos Convenio</a></li>';
                            }
                            if ($tipo_usuario=="AA"){
